...
# ===========================================================================
HOST = "satvik"   # shown as  satvik@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "CS Undergrad @ ITM Gwalior (RGPV)"),
    ("kv", "Founder", "GIG3 Tech Community"),
    ("kv", "Focus", "Full-Stack & AI Development"),
    ("kv", "Prev", "Freelance Full-Stack Developer"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Java, JavaScript, Dart, SQL"),
    ("kv", "Frontend", "React, Next.js, Flutter, Tailwind"),
    ("kv", "Backend", "Spring Boot, FastAPI, Node.js"),
    ("kv", "Data / AI", "MySQL, MongoDB, Redis, LangChain"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Top 5/30 @ Avalanche Hackathon \u2014 SecurePay"),
    ("bul", "Founder of GIG3 Tech Community"),
]
